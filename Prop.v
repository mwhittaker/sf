...
Proof.
  intros n m B.
  (* induct on [m] since [*] is recursive on its first arg *)
  induction m as [| m'].
  Case "m = 0".
    apply b_0.
  Case "m = S m'".
    simpl.
    apply b_sum.
    SCase "n is beautiful". apply B.
    SCase "(m' * n) is beautiful". apply IHm'.
Qed.
(** [] *)
...
Proof.
  ...
  Case "b_sum".
    apply gorgeous_sum.
    SCase "gorgeous n'". apply IHB1.
    SCase "gorgeous m'". apply IHB2.
Qed.
(** [] *)
